...
module Exercises = struct
  ...
  let%expect_test "print_win_for_x" =
    ...
    [%expect
      {|
      (board
       ((((row 0) (column 0)) X) (((row 0) (column 1)) O) (((row 0) (column 2)) X)
        (((row 1) (column 0)) O) (((row 1) (column 1)) O) (((row 1) (column 2)) X)
        (((row 2) (column 0)) O) (((row 2) (column 1)) X) (((row 2) (column 2)) X)))
      |}];
    return ()
  ;;
  ...
  let%expect_test "print_non_win" =
    ...
    [%expect
      {|
      (board
       ((((row 0) (column 0)) X) (((row 1) (column 0)) O) (((row 2) (column 0)) O)
        (((row 2) (column 2)) X)))
      |}];
    return ()
  ;;
